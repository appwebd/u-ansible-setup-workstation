...
condition: any
rules: ['c:systemctl show rsyslog.service -> r:^LoadState=loaded|^ActiveState=active', 'c:systemctl show systemd-journal-upload.service -> r:^UnitFileState=enabled|^ActiveState=active']
